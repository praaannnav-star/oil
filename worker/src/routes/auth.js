...
const DEMO_USERS = [
  ...
  { id: 'USR-FIELD-01', username: 'supervisor', name: 'Manoj Kalita', title: 'Resident Field Engineer & Site Supervisor', role: 'Field Supervisor', department: 'Field Operations & Construction — Rig 04', avatar: '👷‍♂️', allowedRoutes: ['/overview', '/projects', '/projects/:id', '/progress', '/progress/new', '/surveys', '/evidence', '/activities/:id'] }
];
